...
### boxsize related
def compute_extract_mics_box(box_size_1, pixel_size_1, box_size_2, pixel_size_2):
    # convert to angstrom
    ...
    if diameter_1 >= diameter_2:
        result = adjust_boxsize(box_size_1, use_eman_boxsizes=True)
    else:
        result = box_size_2 / 0.95
